...
let s:I1 = [ '#00005f' , '#00dfff' , 238  , 190  ]
let s:I2 = [ '#ffffff' , '#005fff' , 255 , 238  ]
...
let g:airline#themes#dark#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#d78700' , s:I1[2] , 190     , ''     ] ,
      \ }
let g:airline#themes#dark#palette.replace = copy(g:airline#themes#dark#palette.insert)
let g:airline#themes#dark#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 1     , ''     ]
let g:airline#themes#dark#palette.replace_modified = g:airline#themes#dark#palette.insert_modified

let s:V1 = [ '#000000' , '#ffaf00' , 232 ,4 ]
let s:V2 = [ '#000000' , '#ff5f00' , 255 , 238 ]
