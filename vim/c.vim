...
"syn region      ifs             start="^\s*#ifd" end="#else"me=e-5,re=e-5,he=e-5 
"syn region      ifs             start="^\s*#if" end="#else"me=e-6,re=e-6,he=e-6 contains=cCSfunc,cCSBFT,cMPIType,cCStype
"syn region      ife             start="#else" end="#endif"
